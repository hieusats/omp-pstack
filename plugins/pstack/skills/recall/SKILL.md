...
Transcripts live under your runtime's per-project transcript directory for the active workspace, one JSONL file per chat. Every line is one chat message.
