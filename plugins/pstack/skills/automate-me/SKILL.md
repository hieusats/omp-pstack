---
name: automate-me
description: "Use for \"automate me\", \"create/update/refresh my -mode skill\", \"turn/capture my preferences or working style into a skill\", or wanting agents to follow how the user works. Drafts or revises a personal -mode skill via SKILL.md authoring discipline + unslop, optionally pulling fresh evidence from recent transcripts."
---
...
This skill orchestrates three others: an inline mining pass (see step 1), SKILL.md authoring discipline (authoring), and the **unslop** skill (prose discipline). It sequences them; it doesn't replace them.

## Flow

### 0. Check for an existing skill

Look recursively for `*-mode/SKILL.md` files under the repo's skills directories and your personal skills directory, matching the user's handle. Mode skills can live in a personal category directory (`skills/<handle>/`), not only at the top level. If one exists, confirm intent with the `ask` tool (unless they already said "update my skill" or similar):
...
Apply the **unslop** skill and SKILL.md authoring discipline's writing guidelines to every line. Both apply to any agent-read prose, not just skills.
...
- User wants a task-specific skill (not working conventions): plain SKILL.md authoring, no mining required.
...
- SKILL.md authoring discipline (name plus description frontmatter, progressive disclosure): the authoring process and writing guidelines.
