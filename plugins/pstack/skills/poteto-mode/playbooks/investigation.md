...
1. Route through the **how** skill (Explain mode for narrow questions, Critique mode for "are we sure?"). For motivation questions, also route through the **why** skill. Skipping stays as `how skipped: <reason>`; do not fold the subsystem mapping silently into the answer.
